...
<template>
  <div class="flex items-stretch h-svh w-full relative">
    <Transition>
      <div v-if="loaded" class="flex items-stretch w-full">
        <section ref="sidebar"
          ...
          <!-- TODO: UTILISER LA NAVIGATION VERTICALE (https://ui.nuxt.com/components/vertical-navigation) -->
    ...
    <Transition>
      <div v-if="!loaded" class="absolute-center flx-center flex-col gap-2 max-w-56 mx-auto">
        <p>Chargement</p>
